...
class UtilRpa:
    ...
    @staticmethod
    def enter_captcha_hilo(name, browser, captcha_find_by, input_result_captcha_by, captcha_image, input_result_captcha,
                           submit_find_by, value_submit, result_captcha_by, value_result_captcha, retry_max,
                           delay_time_skip,
                           check_num=False, callback=None, callback_args=None, form_btn_handle="submit"):
        retry = 0
        while retry < retry_max:
