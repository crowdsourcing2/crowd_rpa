...
from crowd_rpa.cores.wininvoice.rpa import win_invoice_ins
from crowd_rpa.cores.yamaha.rpa import yamaha_ins
from crowd_rpa.cores.gas_petrolimex.rpa import gas_petrolimex_ins
